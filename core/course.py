...
CONERO_GOLF_CLUB = GolfCourse(
    ...
    holes=[
        HoleInfo(hole_number=1, par=4, distance_meters=342, handicap_index=5, slope_elevation_profile="Primi 2/3 in pianura, ultimo terzo in salita"),
        HoleInfo(hole_number=2, par=3, distance_meters=134, handicap_index=17, slope_elevation_profile="In discesa"),
        HoleInfo(hole_number=3, par=4, distance_meters=402, handicap_index=3, slope_elevation_profile="Primi 2/3 in discesa, ultimo terzo in pianura"),
        HoleInfo(hole_number=4, par=5, distance_meters=433, handicap_index=15, slope_elevation_profile="In pianura"),
        HoleInfo(hole_number=5, par=4, distance_meters=292, handicap_index=9, slope_elevation_profile="In pianura"),
        HoleInfo(hole_number=6, par=3, distance_meters=139, handicap_index=13, slope_elevation_profile="In pianura"),
        HoleInfo(hole_number=7, par=4, distance_meters=320, handicap_index=7, slope_elevation_profile="Primo terzo in pianura, 2/3 finali in salita"),
        HoleInfo(hole_number=8, par=4, distance_meters=343, handicap_index=11, slope_elevation_profile="Prima metà in discesa, resto in pianura"),
        HoleInfo(hole_number=9, par=4, distance_meters=390, handicap_index=1, slope_elevation_profile="Prima metà in salita, seconda metà in leggera salita"),
        HoleInfo(hole_number=10, par=4, distance_meters=334, handicap_index=10, slope_elevation_profile="Prima metà in discesa, seconda metà in salita"),
        HoleInfo(hole_number=11, par=4, distance_meters=307, handicap_index=6, slope_elevation_profile="Tutto in salita"),
        HoleInfo(hole_number=12, par=5, distance_meters=477, handicap_index=18, slope_elevation_profile="Tutto in discesa"),
        HoleInfo(hole_number=13, par=3, distance_meters=168, handicap_index=14, slope_elevation_profile="In pianura"),
        HoleInfo(hole_number=14, par=4, distance_meters=287, handicap_index=12, slope_elevation_profile="In pianura"),
        HoleInfo(hole_number=15, par=5, distance_meters=500, handicap_index=4, slope_elevation_profile="In pianura"),
        HoleInfo(hole_number=16, par=3, distance_meters=133, handicap_index=16, slope_elevation_profile="In salita"),
        HoleInfo(hole_number=17, par=4, distance_meters=376, handicap_index=8, slope_elevation_profile="Tutto in discesa"),
        HoleInfo(hole_number=18, par=4, distance_meters=334, handicap_index=2, slope_elevation_profile="Tutto in salita"),
    ]
)
